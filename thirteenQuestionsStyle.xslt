...
<table>
	...
	<tr>
		<td style="color: Black; text-align:left; border-collapse: collapse;"><xsl:value-of select="Checklist/Dealer/QnA/Question4"/></td>
	...
	<tr>
		<td style="color: Black; text-align:justify; border-collapse: collapse;"><xsl:value-of select="Checklist/Dealer/QnA/Answer14"/></td>
	</tr>
	<tr>
